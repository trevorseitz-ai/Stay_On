...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const updateSafeTop = () => {
      ...
      safeTop = parseFloat(window.getComputedStyle(el).top) || 0;
    ...
    const drawBannerAd = () => {
      ...
      ctx.lineWidth = 2;
      ctx.fillRect(x, top, boardW, 56);
      ctx.strokeRect(x, top, boardW, 56);
      ctx.fillStyle = "rgba(235,245,246,.38)";
      ctx.textAlign = "left";
      ctx.font = "600 7px ui-monospace, monospace";
      ctx.fillText("ADVERTISEMENT", x + 6, top + 10);
      ctx.fillStyle = "rgba(235,245,246,.72)";
      ctx.textAlign = "center";
      ctx.font = "700 12px ui-monospace, monospace";
      ctx.fillText("YOUR AD HERE", width / 2, top + 34);
    };
